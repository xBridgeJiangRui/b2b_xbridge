  ...
  var ImageDialog = /** @class */ (function () {
      ...
      ImageDialog.prototype.initialize = function () {
          ...
          var body = [
              ...
              '<input id="inputFileToLoad" class="note-image-input note-form-control note-input" ',
          ...
          var footer = "<input id=\"insert_image\" type=\"button\" href=\"#\" class=\"" + buttonClass + "\" value=\"" + this.lang.image.insert + "\" disabled>";
          this.$dialog = this.ui.dialog({
